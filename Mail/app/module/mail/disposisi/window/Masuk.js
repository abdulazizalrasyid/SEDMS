...
Ext.define("Docs.view.disposisi.window.Masuk",{
    extend: "Ext.window.Window",
    requires:[
        "Docs.view.disposisi.window.MasukController",
        "Docs.view.disposisi.window.MasukModel"
    ],
    controller: "disposisi-window-masuk",
    viewModel: {
        type: "disposisi-window-masuk"
    },
    xtype:"disposisi.window.Masuk",
    width:800,
    height:585,
    modal:true,
    resizable:false,
