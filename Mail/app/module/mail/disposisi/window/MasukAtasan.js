...
Ext.define("Docs.view.disposisi.window.MasukAtasan",{
    extend: "Ext.window.Window",
    requires:[
        "Docs.view.disposisi.window.MasukAtasanController",
        "Docs.view.disposisi.window.MasukAtasanModel"
    ],
    controller: "disposisi-window-masukatasan",
    viewModel: {
        type: "disposisi-window-masukatasan"
    },
    xtype:"disposisi.window.MasukAtasan",
    width:800,
    height:585,
    modal:true,
    resizable:false,
