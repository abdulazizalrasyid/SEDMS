...
Ext.define("Docs.view.disposisi.grid.monitor.Masuk",{
    extend: "Ext.grid.Panel",
    requires:[
        "Docs.view.disposisi.grid.monitor.MasukController",
        "Docs.view.disposisi.grid.monitor.MasukModel"
    ],
    controller: "disposisi-grid-monitor-masuk",
    viewModel: {
        type: "disposisi-grid-monitor-masuk"
    },
    xtype:"disposisi.grid.monitor.Masuk",
    title:'Disposisi',
