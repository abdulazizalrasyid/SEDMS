...
Ext.define("Docs.view.disposisi.grid.monitor.Keluar",{
    extend: "Ext.grid.Panel",
    requires:[
        "Docs.view.disposisi.grid.monitor.KeluarController",
        "Docs.view.disposisi.grid.monitor.KeluarModel"
    ],
    controller: "disposisi-grid-monitor-keluar",
    viewModel: {
        type: "disposisi-grid-monitor-keluar"
    },
    xtype:"disposisi.grid.monitor.Keluar",
    title:'Keluar',
