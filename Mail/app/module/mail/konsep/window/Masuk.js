...
Ext.define("Docs.view.konsep.window.Masuk",{
    extend: "Ext.window.Window",
    requires:[
        "Docs.view.konsep.window.MasukController",
        "Docs.view.konsep.window.MasukModel"
    ],
    controller: "konsep-window-masuk",
    viewModel: {
        type: "konsep-window-masuk"
    },
    xtype:"konsep.window.Masuk",
    width:600,
    modal:true,
    //height:400,
