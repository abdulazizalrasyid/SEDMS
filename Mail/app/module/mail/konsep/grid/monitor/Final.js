...
Ext.define("Docs.view.konsep.grid.monitor.Final",{
    extend: "Ext.grid.Panel",
    requires:[
        "Docs.view.konsep.grid.FinalController",
        "Docs.view.konsep.grid.FinalModel"
    ],
    controller: "konsep-grid-monitor-final",
    viewModel: {
        type: "konsep-grid-monitor-final"
    },
    xtype:"konsep.grid.monitor.Final",
    title:'Final',
    ...
    columns: [
       ...
       {text:'Pengirim',dataIndex:'nomor_surat',flex:4,
            renderer:function(value, metadata, record, rowIndex,colIndex, store){
                ...
                dataShow = "<div> Perihal:"+record.data.perihal+" | Nota Tgl:"+Ext.util.Format.date(record.data.created_on,'d-m-Y')+"</div><div>"+record.data.isi_nota+"</div>"
