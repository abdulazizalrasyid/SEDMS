Ext.define('Docs.view.arsip.grid.UnarchivedController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.arsip-grid-unarchived',
    onRender:function(){
        me = this;
    ...
    onBeforeActivate:function(){
        me=this;
        me.getViewModel().getStore('daftar_unarchived').reload();
        me.lookupReference('paging_unarchived').setStore(me.getView().getStore());
    ...
    openInmailView:function(selectedRecord,activeTab){
        ...
        win = Ext.create('Docs.view.arsip.window.Unarchived');
        form = win.down('#form_surat').getForm();
        //form2 = win.down('#display_detail').getForm();
        tab = win.down('tabpanel');
        //tab.setActiveItem(activeTab);
        
        //console.log(selectedRecord);
        form.loadRecord(selectedRecord);
        //form2.loadRecord(selectedRecord);
        win.show();
    },
