Ext.define('Docs.view.arsip.grid.UnarchivedDraftController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.arsip-grid-unarchiveddraft',
    onRender:function(){
        me = this;
    ...
    openInmailView:function(selectedRecord,activeTab){
        var me = this;
        win = Ext.create('Docs.view.arsip.window.UnarchivedDraft');
