...
Ext.define("Docs.view.arsip.window.UnarchivedDraft",{
    extend: "Ext.window.Window",
    requires:[
        "Docs.view.arsip.window.UnarchivedDraftController",
        "Docs.view.arsip.window.UnarchivedDraftModel"
    ],
    controller: "arsip-window-unarchiveddraft",
    viewModel: {
        type: "arsip-window-unarchiveddraft"
    },
    xtype:"arsip.window.unarchivedDraft",
    width:600,
    height:400,
    modal:true,
    layout:'fit',
