Ext.define('Docs.view.arsip.window.UnarchivedDraftController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.arsip-window-unarchiveddraft',
    activate:function(){
        me=this;
    ...
    onBeforeClose:function(){
        Ext.globalEvents.fireEvent( 'refreshGridUnarchivedDraft' );
    },
...
/*                me.lookupReference('waktu_aktif').setValue(text.waktu_aktif+' tahun');
    ...
    onSimpanArsip:function(){
        ...
        if (form.isValid()) {
                ...
                function(btn) {
                    if (btn === 'yes') {
                        form.url = serverURL+'konsep/arsip';
                        ...
                        form.submit({
                            ...
                            failure: function(form, action) {
                                console.log('gagal mengarsipkan konsep surat');
                            }
                        });
                    } else {
                        return false;
