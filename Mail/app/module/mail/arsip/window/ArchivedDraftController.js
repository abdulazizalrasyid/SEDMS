Ext.define('Docs.view.arsip.window.ArchivedDraftController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.arsip-window-archiveddraft',
    activate:function(){
        me=this;
    ...
    onBeforeClose:function(){
        Ext.globalEvents.fireEvent( 'refreshGridArchivedDraft' );
    },
                ...
                function(btn) {
                    if (btn === 'yes') {
                        ...
                        form.submit({
                            ...
                            failure: function(form, action) {
                                console.log('gagal mengedit arsip');
                            }
                        });
                    } else {
                        return false;
