Ext.define('Docs.view.nodin.grid.monitor.KeluarController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.nodin-grid-monitor-keluar',
    render:function(){
        me = this;
    ...
    activate:function(){
        me=this;
        me.getView().getStore().reload();
        me.lookupReference('pagingnodinkeluar').setStore(me.getView().getStore());
    ...
    openInmailView:function(selectedRecord,activeTab){
       var me = this;
        ...
        var win = Ext.create('Docs.view.nodin.window.Keluar');
