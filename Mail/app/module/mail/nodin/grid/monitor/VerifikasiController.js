Ext.define('Docs.view.nodin.grid.monitor.VerifikasiController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.nodin-grid-monitor-verifikasi',
    render:function(){
        me = this;
    ...
    activate:function(){
        me=this;
        me.getView().getStore().reload();
        me.lookupReference('pagingverifikasi').setStore(me.getView().getStore());
    ...
    openInmailView:function(selectedRecord,activeTab){
       var me = this;
        ...
        var win = Ext.create('Docs.view.nodin.window.Verified');
