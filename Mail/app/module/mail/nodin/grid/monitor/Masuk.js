...
Ext.define("Docs.view.nodin.grid.monitor.Masuk",{
    extend: "Ext.grid.Panel",
    requires:[
        "Docs.view.nodin.grid.monitor.MasukController",
        "Docs.view.nodin.grid.monitor.MasukModel"
    ],
    controller: "nodin-grid-monitor-masuk",
    viewModel: {
        type: "nodin-grid-monitor-masuk"
    },
    xtype:"nodin.grid.monitor.Masuk",
    title:"Nota Dinas",
