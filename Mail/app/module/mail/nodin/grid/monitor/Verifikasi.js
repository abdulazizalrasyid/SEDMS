...
Ext.define("Docs.view.nodin.grid.monitor.Verifikasi",{
    extend: "Ext.grid.Panel",
    requires:[
        "Docs.view.nodin.grid.monitor.VerifikasiController",
        "Docs.view.nodin.grid.monitor.VerifikasiModel"
    ],
    controller: "nodin-grid-monitor-verifikasi",
    viewModel: {
        type: "nodin-grid-monitor-verifikasi"
    },
    title:'Verifikasi',
    iconCls:'icon_nodin_unverified_16',
    xtype:"nodin.grid.monitor.Verifikasi",
     bind:{
        store:'{nodinkeluar}'
    },
    viewConfig:{
