Ext.define('Docs.view.nodin.grid.BaruController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.nodin-grid-baru',
    init:function(){
        me=this;
        ...
        if (Mail.LoggedInUser.data.type == 'staf' || Mail.LoggedInUser.data.type == 'operator') {
            me.lookupReference('penandatangan').setValue(Mail.LoggedInUser.data.jabatan_atasan);
            ...
            if (Mail.LoggedInUser.data.kode_jabatan_atasan.substring(0,1) == 'S'){
                me.lookupReference('unit_pemrakarsa').setValue(Mail.LoggedInUser.data.kode_jabatan_atasan.substring(0,2));
            } else {
                me.lookupReference('unit_pemrakarsa').setValue(Mail.LoggedInUser.data.kode_jabatan_atasan.substring(0,3));
            }
            //me.lookupReference('unit_pemrakarsa').setValue(Mail.LoggedInUser.data.kode_jabatan_atasan);
            me.lookupReference('kode_jab_pengirim').setValue( Mail.LoggedInUser.data.kode_jabatan_atasan );
            me.lookupReference('id_jab_pengirim').setValue( Mail.LoggedInUser.data.id_atasan );
            me.getViewModel().set('id_jabatan',Mail.LoggedInUser.data.id_atasan);
        }else{
            me.lookupReference('verified').setValue(1);
            me.lookupReference('penandatangan').setValue(Mail.LoggedInUser.data.jabatan);
            me.lookupReference('unit_pemrakarsa').setValue(Mail.LoggedInUser.data.kode_jabatan);
            ...
            me.getViewModel().set('id_jabatan',Mail.LoggedInUser.data.id_jabatan);
            if (Mail.LoggedInUser.data.kode_jabatan.substring(0,1) == 'S'){
                me.lookupReference('unit_pemrakarsa').setValue(Mail.LoggedInUser.data.kode_jabatan.substring(0,2));
            } else {
                me.lookupReference('unit_pemrakarsa').setValue(Mail.LoggedInUser.data.kode_jabatan.substring(0,3));
            }
        }

        //console.log(Mail.LoggedInUser.data.id_atasan);
        
        /*selected = me.lookupReference('penandatangan').valueModels[0].data;
        
        me.getViewModel().set('id_atasan',selected.id_atasan);*/

        me.lookupReference('verification_request_id_jab').setHidden( true );
        me.setNomorSurat();

        //me.lookupReference('unit_pemrakarsa').setStore(me.getViewModel().getStore('unit_pemrakarsa'));
    },
    setNomorSurat:function(){
        ...
        //me.getViewModel().set('id_jabatan',me.lookupReference('id_jab_pengirim').getValue());
        ...
        Ext.Ajax.request({
            ...
            params:{
                ...
                unit_pemrakarsa:me.lookupReference('unit_pemrakarsa').getValue()
            },
            success: function( response, options ) {
                ...
                me.lookupReference('nomor_surat_fake').setValue(nomor+'/'+unit_pemrakarsa+/*'/'+ me.lookupReference('kode_klasifikasi').getValue()+*/'/'+bulan+'/'+tahun);
                me.lookupReference('nomor_surat').setValue(nomor+'/'+unit_pemrakarsa+/*'/'+ me.lookupReference('kode_klasifikasi').getValue()+*/'/'+bulan+'/'+tahun);
    ...
    selectPengirim:function(me, records){
        me=this;
        ...
        //console.log(records[0].data.kode_unker);
        // console.log(Mail.LoggedInUser.data.id_jabatan);

        if ( records[0].data.id_jab_pengirim != Mail.LoggedInUser.data.id_jabatan){
            me.lookupReference('verified').setValue(0);
        ...
        if (records[0].data.kode_jabatan.substring(0,1) == 'S'){
            me.lookupReference('unit_pemrakarsa').setValue(records[0].data.kode_jabatan.substring(0,2));
        } else {
            me.lookupReference('unit_pemrakarsa').setValue(records[0].data.kode_jabatan.substring(0,3));
        }
        //me.lookupReference('unit_pemrakarsa').setValue(records[0].data.kode_jabatan);
