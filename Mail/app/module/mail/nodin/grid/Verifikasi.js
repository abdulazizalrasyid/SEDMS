...
Ext.define("Docs.view.nodin.grid.Verifikasi",{
    extend: "Ext.grid.Panel",
    requires:[
        "Docs.view.nodin.grid.VerifikasiController",
        "Docs.view.nodin.grid.VerifikasiModel"
    ],
    controller: "nodin-grid-verifikasi",
    viewModel: {
        type: "nodin-grid-verifikasi"
    },
    title:'Verifikasi',
    iconCls:'icon_nodin_unverified_16',
    xtype:"nodin.grid.Verifikasi",
     bind:{
        store:'{nodinkeluar}'
    },
    viewConfig:{
