...
Ext.define("Docs.view.nodin.grid.Unclassified",{
    extend: "Ext.grid.Panel",
    requires:[
        "Docs.view.nodin.grid.UnclassifiedController",
        "Docs.view.nodin.grid.UnclassifiedModel"
    ],
    controller: "nodin-grid-unclassified",
    viewModel: {
        type: "nodin-grid-unclassified"
    },
    xtype:"nodin.grid.Unclassified",
    iconCls:'icon_nodin_unverified_16',
    title:"Belum Terklasifikasi",
    bind:{
        store:'{datasurat}'
    },
    viewConfig:{
