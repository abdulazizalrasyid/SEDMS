Ext.define('Docs.view.nodin.grid.MasukController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.nodin-grid-masuk',
    render:function(){
        me = this;
    ...
    openInmailView:function(selectedRecord,activeTab){
       var me = this;
        ...
        var win = Ext.create('Docs.view.nodin.window.Masuk');
        ...
        Ext.Ajax.request({
            url: serverURL+'notadinas/update.json',
            method:'post',
            params:{
                id:selectedRecord.data.id,
                uniquecode:selectedRecord.data.uniquecode,
                type:'baca'
            }
        }); 
