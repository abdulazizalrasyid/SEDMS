...
Ext.define("Docs.view.nodin.window.OprMasuk",{
    extend: "Ext.window.Window",
    requires:[
        "Docs.view.nodin.window.OprMasukController",
        "Docs.view.nodin.window.OprMasukModel"
    ],
    controller: "nodin-window-oprmasuk",
    viewModel: {
        type: "nodin-window-oprmasuk"
    },
    xtype:"nodin.window.OprMasuk",
    width:800,
    height:585,
    modal:true,
    resizable:false,
