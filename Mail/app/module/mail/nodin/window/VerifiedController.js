Ext.define('Docs.view.nodin.window.VerifiedController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.nodin-window-verified',
    init:function(){
        me=this;
    ...
    beforeclose:function(){
        Ext.globalEvents.fireEvent( 'refreshGridVerifikasinodin' );
    ...
    onClickSimpan:function(){
        var me = this; 
        form = me.lookupReference('theform').getForm(),
        ...
        Ext.Ajax.request({
            ...
            success: function( response, options ) {
                ...
                if (result.success == true){
                    ...
                    //start process
                        if (form.isValid()) {
                                Ext.Msg.confirm('Konfirmasi', 'Apakah anda yakin akan menyimpan mengirim Nota dinas ini?',
                                function(btn) {
                                    if (btn === 'yes') {
