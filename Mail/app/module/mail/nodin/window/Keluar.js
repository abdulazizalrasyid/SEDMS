...
Ext.define("Docs.view.nodin.window.Keluar",{
    extend: "Ext.window.Window",
    requires:[
        "Docs.view.nodin.window.KeluarController",
        "Docs.view.nodin.window.KeluarModel"
    ],
    controller: "nodin-window-keluar",
    viewModel: {
        type: "nodin-window-keluar"
    },
    xtype:"nodin.window.Keluar",
    //html: "Hello, World!!",
    width:800,
    height:585,
    modal:true,
