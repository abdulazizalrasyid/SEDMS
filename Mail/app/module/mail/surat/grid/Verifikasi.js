...
Ext.define("Docs.view.surat.grid.Verifikasi",{
    extend: "Ext.grid.Panel",
    requires:[
        "Docs.view.surat.grid.VerifikasiController",
        "Docs.view.surat.grid.VerifikasiModel"
    ],
    controller: "surat-grid-verifikasi",
    viewModel: {
        type: "surat-grid-verifikasi"
    },
    title:'Verifikasi',
