Ext.define('Docs.view.surat.grid.MasukController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.surat-grid-masuk',
    render:function(){
        me = this;
    ...
    activate:function(){
        ...
        me.lookupReference('masuksearch').setStore(me.getView().getStore());
    },
    init:function(){
    	me=this;
    ...
    openInmailView:function(selectedRecord,activeTab){
        ...
        win = Ext.create('Docs.view.surat.window.Masuk');
