...
Ext.define("Docs.view.surat.grid.monitor.Masuk",{
    extend: "Ext.grid.Panel",
    requires:[
        "Docs.view.surat.grid.monitor.MasukController",
        "Docs.view.surat.grid.monitor.MasukModel"
    ],
    controller: "surat-grid-monitor-masuk",
    viewModel: {
        type: "surat-grid-monitor-masuk"
    },
    title:'Masuk',
    xtype:"surat.grid.monitor.Masuk",
