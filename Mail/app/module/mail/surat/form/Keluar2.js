...
Ext.define("Docs.view.surat.form.Keluar2",{
    extend: "Ext.panel.Panel",
    requires:[
        "Docs.view.surat.form.Keluar2Controller",
        "Docs.view.surat.form.Keluar2Model"
    ],
    controller: "surat-form-keluar2",
    viewModel: {
        type: "surat-form-keluar2"
    },
    xtype:"surat.form.Keluar2",
    //itemId:'suratKeluar2',
                ...
                items:[
                    {
                        ...
                        reference:'unit_pemrakarsa2'
                    },{
                        xtype:'hiddenfield',
                        name:'penandatangan',
                        reference:'penandatangan2'
                    },{
                        flex: 1,
                        xtype:'combobox',
                        labelWidth:150,
