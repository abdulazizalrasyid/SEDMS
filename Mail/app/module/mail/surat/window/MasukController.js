Ext.define('Docs.view.surat.window.MasukController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.surat-window-masuk',
    init:function(){
        me=this;
    ...
    beforeclose:function(){
        ...
        Ext.globalEvents.fireEvent( 'refreshGridSuratMasuk' );
        Ext.globalEvents.fireEvent( 'refreshMenu' );
    },
    onCetakDisposisi:function(){
        var me = this;
        var id_surat = me.lookupReference('id_surat').getValue();
