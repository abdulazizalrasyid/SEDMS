...
class Karsip extends REST_Controller {

	public function __construct(){
		parent:: __construct();
		$this->load->model(array('Karsip_model'));
 	...
 	public function daftar_get()
 	{
		...
		$data = $this->Karsip_model->daftar($filter,$limit,$start);
	...
	{ 	
		...
		$this->Karsip_model->simpan($input);
	...
	{ 	
		...
		$this->Karsip_model->update($input);
